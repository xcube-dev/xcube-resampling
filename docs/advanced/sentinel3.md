## Example of applying rectification to a Sentinel-3 OLCI scene

One example where rectification is often applied, is Sentinel-3 products. 
...
are shown:  
![OLCI L1B Input](../images/olci-input.png)

The given coordinates, latitude and longitude, are *terrain corrected* with 
...
A *rectification* is the transformation of satellite imagery from its original 
...
![OLCI L1C Output](../images/olci-output.png)
...
![Source coordinates](../images/source-coords.png)
...
![solve-bilinear](../images/solve-bilinear.png)
