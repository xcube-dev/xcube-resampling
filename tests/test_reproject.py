...
class ReprojectDatasetTest(unittest.TestCase):
    ...
    def test_reproject_complex_dask_array(self):
        ...
        self.assertAlmostEqual(
            target_ds.temperature.values[0, 0, 0], 6353.581, places=4
        )
        self.assertAlmostEqual(
            target_ds.temperature.values[0, -1, -1], 3007.1187, places=4
        )
        self.assertEqual(
            [2, 5, 5],
            [
        ...
        self.assertAlmostEqual(
            target_ds.temperature.values[0, -1, -1], 3007.1186, places=4
        )
        self.assertEqual(
            [2, 5, 5],
            [
